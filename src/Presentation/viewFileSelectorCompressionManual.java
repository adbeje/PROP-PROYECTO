/** @file viewFileSelectorCompressionManual.java
 * @brief Aquesta classe és la view del selector d'arxius de la compressió manual.
 *
...
/*
 * Classe viewFileSelectorCompressionManual
 */

/** @class viewFileSelectorCompressionManual
 *  @brief Aquest és la view del selector d'arxius de la compressió manual.
 *
 *  @author Adria Ventura i Herce
 */
public class viewFileSelectorCompressionManual extends javax.swing.JFrame {
    ...
    /** @brief Creadora per defecte de viewFileSelectorCompressionManual.
     * 
     * @param cP Es el controlador de presentació.
     * 
     * \pre <em>Cert.</em>
     * \post Ha creat una instància de viewFileSelectorCompressionManual.
     */
    public viewFileSelectorCompressionManual(CtrlPresentation cP) {
        ...
        panelEstadistiquesLayout.setHorizontalGroup(
            ...
            .addGroup(panelEstadistiquesLayout.createSequentialGroup()
                ...
                .addGroup(panelEstadistiquesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(labelTempsCom, javax.swing.GroupLayout.PREFERRED_SIZE, 323, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
                ...
                .addGroup(slectorFilesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(slectorFilesLayout.createSequentialGroup()
                        ...
                        .addGroup(slectorFilesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btnSelecciona, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(slectorFilesLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(slectorFilesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(in_path, javax.swing.GroupLayout.DEFAULT_SIZE, 284, Short.MAX_VALUE)
    ...
    private void btnSeleccionaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionaActionPerformed
        ...
        if(in.equals("") || out.equals("")) {
            ...
            try {
                ctrlPresentation.manualCompressFile(in, out, algorithmType);
    ...
    /** @brief Canvi de form del selector d'arxius compressió manual a form de selecció d'algorismes.
     * 
     * @param evt
     * 
     * \pre <em>Cert.</em>
     * \post Ha canviat del form del selector d'arxius compressió manual a form de selecció d'algorismes.
     */
    private void labelBackMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelBackMouseClicked
        resetVariables();
        ctrlPresentation.syncViewFSCM_to_viewAlg();
    ...
    /** @brief Canvi de form de selecctor d'algoritmes a form de accions.
     * 
     * @param evt
     * 
     * \pre <em>Cert.</em>
     * \post Ha canviat del form de selecctor d'algoritmes a form de accions.
     */
    private void labelAccionsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelAccionsMouseClicked
        resetVariables();
        ctrlPresentation.syncViewFSCM_to_viewA();
    ...
    private void btnPrevisualitzaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrevisualitzaActionPerformed
        ...
        if (in.equals("")) {
            ...
            try {
                ctrlPresentation.manualCompressFile(in, out + "Pre", algorithmType);
